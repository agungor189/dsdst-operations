...
const EXPECTED_SERVICES = {
  "dsdst-panel": {
    ...
    schemaKind: "sqlite",
    schemaPath: {path_key: "DB_PATH", mount_target: "/data"},
  ...
  "label-printer": {
    ...
    schemaPath: {directory_key: "DATA_DIR", filename_key: "STATE_FILE", mount_target: "/app/data"},
...
export function getRuntimeServicePolicies() {
  return Object.entries(EXPECTED_SERVICES).map(([service_id, expected]) => ({
    ...
    schema_path: structuredClone(expected.schemaPath),
