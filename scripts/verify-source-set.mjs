...
const manifestPath = path.resolve(process.env.SOURCE_SET_MANIFEST || path.join(root, "config", "v2-03-source-set.json"));
...
if (manifest.release !== "V2-03") throw new Error("Unsupported source-set release: expected V2-03");
