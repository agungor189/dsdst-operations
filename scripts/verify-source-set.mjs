...
const manifestPath = path.resolve(process.env.SOURCE_SET_MANIFEST || path.join(root, "config", "v2-06-source-set.json"));
...
if (manifest.release !== "V2-06") throw new Error("Unsupported source-set release: expected V2-06");
